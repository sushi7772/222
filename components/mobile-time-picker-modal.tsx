...
export default function MobileTimePickerModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-slate-800 border-slate-700 mx-4 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-white text-center">Set Timer</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6 pb-4">
            ...
            <div className="grid grid-cols-4 gap-3 mt-3">
              {PRESET_TIMES.map((preset) => (
                <Button
                  ...
                  className="bg-slate-700 hover:bg-slate-600 text-slate-200 border-slate-600 hover:border-slate-500 h-12 text-sm"
                >
                  {preset.label}
                </Button>
              ))}
            ...
            <div className="flex items-center gap-3 mt-3">
              <div className="flex-1">
                ...
                <Input
                  ...
                  className="bg-slate-700 border-slate-600 text-white text-center h-12 text-lg"
                  placeholder="00"
                />
              </div>
              <div className="text-slate-400 text-2xl font-bold mt-5">:</div>
              <div className="flex-1">
          ...
          <div className="flex gap-3 pt-2">
            <Button
              variant="outline"
              onClick={onClose}
              className="flex-1 bg-slate-700 hover:bg-slate-600 text-slate-200 border-slate-600 h-12"
            >
              Cancel
            </Button>
            <Button onClick={handleCustomTime} className="flex-1 bg-amber-600 hover:bg-amber-700 text-white h-12">
              Set Timer
            </Button>
          </div>
        </div>
